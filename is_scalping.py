...
def detect_seconds_scalping(df: pd.DataFrame) -> pd.DataFrame:
    df2 = prepare_trades(df)
    report = aggregate_by_account(df2)
    return report
...
if __name__ == "__main__":
    ...
    '''暫時從本地文件讀取'''
    trades = pd.read_html("C:\\Users\\Frank W\\OneDrive - Logtec Innovation Limited\\Desktop\\Data Integration\\Abnormal Accounts\\Statement_1456674.htm", header=2)[0]
